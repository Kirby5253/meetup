				...
				<div className="Event">
					<div className="eventCard">
						<ul>
							...
							<li className="event-name">{this.state.event.name}</li>
							<li className="event-group">{this.state.event.group.name}</li>
							<li className="event-rsvp">{this.state.event.yes_rsvp_count} are going</li>
						</ul>
				...
				<div className="Event">
					<div className="eventCard__details">
						<ul>
							...
							<li className="event-name__details">{this.state.event.name}</li>
							<li className="event-group__details">{this.state.event.group.name}</li>
							<li className="event-rsvp__details">{this.state.event.yes_rsvp_count} are going</li>
							...
							<li className="event-description__details">{this.state.event.description}</li>
							<li className="event-link__details">
								<a href={this.state.event.link}> Event Link</a>
							</li>
						</ul>
